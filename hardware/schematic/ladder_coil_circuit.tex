...
\node[note, anchor=north west] at (0.15,2.62) {120\,V hot};
\node[font=\small\bfseries, anchor=south] at (22,2.7) {L2};
\node[note, anchor=north east] at (21.85,2.62) {neutral / return};
...
\ncc{12.4}{0}
\dlabel{12.4}{TSTAT}{NC bimetallic,\\opens $\sim$110\,\textdegree C,\\autoresets $\sim$70\,\textdegree C}
...
\coilsym{20.6}{0}
\dlabel{20.6}{M1}{contactor coil,\\Gould/ITE A202C,\\NEMA Size 1, 120\,V}
...
\node[legendbox, anchor=north west, text width=10.6cm] at (0,-6.0) {%
  ...
  \begin{tabular}{@{}p{1.35cm}@{\hspace{5pt}}p{1.15cm}@{\hspace{5pt}}p{5.4cm}@{}}
    ...
    TSTAT  & NC & winding $\sim$110\,\textdegree C, or a broken lead\\[1pt]
